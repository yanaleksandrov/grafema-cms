				...
				[
					...
					'fields'        => [
						...
						[
							...
							'reset'       => 0,
							'before'      => '',
							'after'       => '<button type="button" class="btn btn--xs btn--primary" @click="" :disabled="images.organization != \'' . Option::get( 'images.organization', 'yearmonth' ) . '\'">Convert existing files</button>',
